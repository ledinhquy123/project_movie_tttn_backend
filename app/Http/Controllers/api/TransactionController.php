...
class TransactionController extends Controller
{
  ...
  public function createTicket(Request $request) {
    ...
    $combos_name = $request->combos_name;
    ...
    $ticket->combos_name = $combos_name;
    $ticket->save();
  ...
  public function paymentVnPay(Request $request) {
    ...
    // $vnp_Returnurl = "http://localhost:8000/api/payment/vn-pay/callback";
    $vnp_Returnurl = "http://localhost:8080/bill/callback";
    $vnp_TmnCode = "O1EHEFM1";//Mã website tại VNPAY 
    $vnp_HashSecret = "DPRYGVZQIGUIYGNBPOUTGCGFOHLJQCMO"; //Chuỗi bí mật

    $vnp_TxnRef = time().""; //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
    $vnp_OrderInfo = 'Thanh toan cho don hang abc';
    $vnp_OrderType = 'bill payment';
    $vnp_Amount = $request->amount * 100; // 20.000 vnđ
    $vnp_Locale = 'VN';
    $vnp_BankCode = 'NCB';
  ...
  public function paymentMomo(Request $request) {
    ...
    $orderId = time() ."";
    $returnUrl = "http://localhost:8080/bill/callback";
    $notifyurl = "http://localhost:8080/bill/callback";
    $bankCode = "SML";
    $requestId = time()."";
