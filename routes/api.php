...
Route::prefix('combos/')->name('combos.')->group(function() {
    Route::get('/', [ComboController::class, 'index'])->name('list');
}); 
...
Route::prefix('auth/')->group(function() {
    Route::get('google', [SocialController::class, 'googleLogin']);
...
Route::prefix('payment/')->group(function() {
    Route::prefix('vn-pay/')->group(function() {
        Route::post('/', [TransactionController::class, 'paymentVnPay'])->name('vn-pay');
    
        Route::get('callback', [TransactionController::class, 'vnPayCallback'])->name('vn-pay-callback');
    });

    Route::prefix('momo/')->group(function() {
        Route::post('/', [TransactionController::class, 'paymentMomo'])->name('momo');
    
        Route::get('callback', [TransactionController::class, 'momoCallback'])->name('momo-callback');
    });
});

// Send mail
Route::post('email', [MailController::class, 'sendSampleMail']);
